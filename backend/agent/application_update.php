...
if ($_SERVER["REQUEST_METHOD"]=="POST") {
    ...
    $stmt="UPDATE `applications_by_agents` SET name=?,email=?,phone=?,country_id=?,application_date=?,university_name=?,course_name=?,intake=? WHERE id=(?)";
    ...
    $application_date123= strtotime(trim($_POST['application_date']));
    $course_name123=trim($_POST['course_name']);
    $intake123=trim($_POST['intake']);
    mysqli_stmt_bind_param($sql,"ssiissssi",$name123,$email123,$phone123,$country123,
    $application_date123,$university_name123,$course_name123,$intake123,$application_id123);
