...
if (isset($_POST["name"]) && isset($_POST["email"]) && isset($_POST["phone"]) && isset($_POST["country"]) && isset($_POST["university"])  ) {
    ...
    (agent_id,name,email,phone,country_id,university_name,application_date,course_name,intake,application_no) VALUES (?,?,?,?,?,?,?,?,?,?)";
    $sql=mysqli_prepare($conn, $stmt);

    //binding the parameters to prepard statement
    mysqli_stmt_bind_param($sql,"issiisssss",$_SESSION['agent_id'],$_POST['name'],$_POST['email'],$_POST['phone'],
    $_POST['country'],$_POST['university'],$_POST['date'],$_POST['course_name'],$_POST['intake'],$application_no);
