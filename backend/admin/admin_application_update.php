...
if ($_SERVER["REQUEST_METHOD"]=="POST") {
             ...
             if ($fileError==0) {
                    if ($fileSize<=6000000) {
                       $all_files=true;
                        ...
                        window.location.href="../../frontend/admin/manage_applications.php";
                        </script>';
                    }
    ...
    $stmt="UPDATE `applications_by_agents` SET name=?,email=?,phone=?,country_id=?,application_date=?,university_name=?,course_name=?,intake=?,status=? 
    WHERE id=(?)";
    ...
    mysqli_stmt_bind_param($sql,"ssiissssii",$_POST['name'],$_POST['email'],$_POST['phone'],$_POST['country'],$_POST['application_date'],
