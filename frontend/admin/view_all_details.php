...
<body>
                            ...
                            <div class="container-fluid p-sm-5 my-5" style="font-size: 22px;">
                                <form id="update_form" action="../../backend/admin/admin_application_update.php" onsubmit="return submitform()" method="post"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <br>
                                        <div class="col-12">
                                            <input type="date" class="form-control" readonly required name="application_date"
                                                value="<?php echo $row["application_date"];?>">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
    ...
    <script>
        ...
        function make_editable() {
            ...
            document.getElementsByName('application_date')[0].removeAttribute('readonly');
