                            ...
                            <table class="table table-hover table-nowrap" id="myTable" style="padding: 30px 2px; border: 0px !important;">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th style="font-size: 16px;">Application <br> Created Date</th>
                                ...
                                <tbody>
                                    ...
                                    if (isset($_GET['filter']) && $_GET['filter'] == 0) {
                                        ...
                                        $stmt = "SELECT status_assumptions.status_name,countries.country_name,applications_by_agents.id,
                                           ...
                                           applications_by_agents.university_name,applications_by_agents.application_date,
                                        ...
                                        $stmt = "SELECT status_assumptions.status_name,countries.country_name,applications_by_agents.id,
                                            ...
                                            applications_by_agents.application_date,
                                            applications_by_agents.application_no,
                                            applications_by_agents.status,
                                            applications_by_agents.created_at
                                            FROM `applications_by_agents`
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    value="<?php echo $row['application_no']; ?>"> -->
                                                        <input type="number" hidden name="country_id" value="<?php echo $row['country_id']; ?>">
                                                        <button type="submit" class="btn btn-neutral p-2" style="font-size: 14px; ">
                                                            <i class="bi bi-eye"></i>
                                                        </button>
                                                    </form>
                                                    ...
                                                    <form style="margin-right: 10px;">
                                                        <button type="button" style="font-size: 14px;" class="btn btn-neutral p-2" data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $row['id']; ?>">
                                                    ...
                                                    <form action="../../backend/admin/delete_application.php" style="margin-right: 10px;" onsubmit="return confirm_delete()" method="post">
                                                        <input type="text" hidden name="from_location" value="manage_applications.php">
                                                        <input type="number" hidden name="doc_id" value="<?php echo $row['id']; ?>">
                                                        <button type="submit" class="btn btn-neutral text-danger p-2" style="font-size: 14px; ">
